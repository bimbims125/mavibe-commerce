              ...
              @foreach($orders as $order)
                <tr>
                    ...
                    <td>
                        ...
                        <a href="https://app.sandbox.midtrans.com/snap/v4/redirection/{{$order->snap_token}}" target="_blank" class="btn btn-info btn-sm float-left mr-1" style="height:30px; width:30px;border-radius:50%" data-toggle="tooltip" title="Pay" data-placement="bottom"><i class="fas fa-dollar-sign"></i></a>
                    </td>
                </tr>
              @endforeach
              @else
