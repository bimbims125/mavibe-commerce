...
class AdminController extends Controller
{
    ...
    public function settingsUpdate(Request $request){
        ...
        // Hapus tag HTML dari short_des dan description jika ada
        $data['short_des'] = strip_tags($data['short_des']);
        $data['description'] = strip_tags($data['description']);

        // Ambil data settings pertama
        $settings = Settings::first();

        // Jika settings tidak ada, buat data baru
        if (!$settings) {
